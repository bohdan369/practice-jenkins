...
![Build Status](https://img.shields.io/badge/build-passing-brightgreen) > my > [![Build Status](http://localhost:8080/buildStatus/icon?job=script)](http://localhost:8080/job/script/)
